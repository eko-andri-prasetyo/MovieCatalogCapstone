...
public final class MovieDao_Impl implements MovieDao {
  ...
  public MovieDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMovieEntity = new EntityInsertionAdapter<MovieEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorite_movies` (`id`,`title`,`poster_url`,`vote_average`,`release_date`) VALUES (?,?,?,?,?)";
      }
  ...
  public Flow<List<MovieEntity>> getFavoriteMovies() {
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"favorite_movies"}, new Callable<List<MovieEntity>>() {
      @Override
      @NonNull
      public List<MovieEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MovieEntity(_tmpId,_tmpTitle,_tmpPosterUrl,_tmpVoteAverage,_tmpReleaseDate);
            _result.add(_item);
          }
          return _result;
        } finally {
