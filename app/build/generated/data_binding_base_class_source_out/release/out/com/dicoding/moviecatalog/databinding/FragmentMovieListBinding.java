...
public final class FragmentMovieListBinding implements ViewBinding {
  ...
  private FragmentMovieListBinding(@NonNull SwipeRefreshLayout rootView,
  ...
  public static FragmentMovieListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMovieListBinding((SwipeRefreshLayout) rootView, progressBar, rvMovies,
          swipeRefresh, tvError);
    }
